...
if hasattr(moe_cfg.attention, "sparse_mla_backend"):
    moe_cfg.attention.sparse_mla_backend = "torch"
...
dataset_config = [
    {
        ...
        "tokenize_fn": OpenaiTokenizeFunctionConfig(chat_template="glm5.2", max_length=1024),
    },
]

dataloader_config = DataloaderConfig(pack_max_length=1024)
